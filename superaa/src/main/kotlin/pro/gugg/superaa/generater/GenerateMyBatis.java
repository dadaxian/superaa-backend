...
public class GenerateMyBatis {
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url="jdbc:mysql://gugg.pro:3306/superaa?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";   //注意修改数据库名
        String name="root";
        String password="Gzz19960814@";

        //数据库表的设置
        List<String> listTable = Arrays.asList("book");  //设置需要自动代码生成的表名
        List<String> listTableSuffix = Arrays.asList("_b");    //设置 过滤 表的后缀
        List<String> listTablePrefix = Arrays.asList("t_","c_"); //设置 过滤 表的前缀

        //基本信息
        String author = "Mr.Xian";    //作者
        String parent = "pro";   //父包名
        String module = "gugg";   //模块包名
